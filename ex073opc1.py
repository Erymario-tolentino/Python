...
times = ('Corinthians' , 'Palmeiras' , 'Santos' , 'Gremio' , 'Cruzeiro' , 'Flamento' , 'Vasco' , 'Chapecoensa' , 'Atletico' , 'Potafogo' , 'Atletico-PR' , 'Bahia' , 'São paulo' , 'Fluminese' , 'Sport recife' , 'Ec vitoria' , 'Coritiba' , 'Avai' , 'Ponte Preta' , 'Atletico-GO' )
print('-=' * 15)
